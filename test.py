...
# np.random.seed(123)
# random.seed(123)
mfcc_001 = sample_from_mfcc(read_mfcc('examples/angie/1.wav', SAMPLE_RATE), NUM_FRAMES)
mfcc_002 = sample_from_mfcc(read_mfcc('examples/tom/2.wav', SAMPLE_RATE), NUM_FRAMES)
...
mfcc_003 = sample_from_mfcc(read_mfcc('examples/angie/3.wav', SAMPLE_RATE), NUM_FRAMES)
